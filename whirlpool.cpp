...
/* Based on https://github.com/rhash/RHash
 *
...
void rhash_swap_copy_str_to_u64(void* to, int index, const void* from, size_t length)
{
	...
	if (0 == (((uintptr_t)to | (uintptr_t)from | (uintptr_t)index | length) & 7)) {
		...
		while (src < end) *(dst++) = soup::Endianness::invert(*(src++));
	}
	else {
...
#if 'ABCD' != 0x41424344ul // Big endian
# define be2me_32(x) (x)
# define be2me_64(x) (x)
# define le2me_32(x) soup::Endianness::invert(x)
# define le2me_64(x) soup::Endianness::invert(x)
...
#else // Little endian
# define be2me_32(x) soup::Endianness::invert(x)
# define be2me_64(x) soup::Endianness::invert(x)
# define le2me_32(x) (x)
# define le2me_64(x) (x)
